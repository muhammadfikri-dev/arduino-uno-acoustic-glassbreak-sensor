/**
 * =========================================================================================
 * Project     : Arduino Uno Dual-Technology Acoustic Glass Break & Vibration Detector
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Security sensor combining low-frequency flex air-pressure wave sensor with high-frequency acoustic glass shatter resonance detector (4-6kHz) to eliminate false alarms.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno Dual-Technology Acoustic Glass Break & Vibration Detector"));
