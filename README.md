# ⚡ Arduino Uno Dual-Technology Acoustic Glass Break & Vibration Detector
...
Security sensor combining low-frequency flex air-pressure wave sensor with high-frequency acoustic glass shatter resonance detector (4-6kHz) to eliminate false alarms.
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `EEPROM`
4. Buka berkas [`arduino-uno-acoustic-glassbreak-sensor.ino`](./arduino-uno-acoustic-glassbreak-sensor.ino).
